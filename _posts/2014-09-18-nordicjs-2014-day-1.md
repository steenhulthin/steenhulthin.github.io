...
[Leah Culver](https://twitter.com/leahculver) gave a number of example of use of the [dropbox JavaScript datastore API](https://www.dropbox.com/developers/chooser) and the [dropbox JavaScript chooser API](https://www.dropbox.com/developers/dropins/chooser/js). 
